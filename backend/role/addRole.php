...
if (isset($_POST["add_role"])) {
    ...
    if (empty($errors)) {
        $insert_new_role = "INSERT INTO role (name, description) VALUES('$name','$description');";
                ...
                <div class="row">
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card shadow">
                            ...
                            <div class="alert <?php echo !empty($roleAddStatus) && strpos($roleAddStatus, 'successfully') !== false ? 'alert-primary' : ''; ?>" id="successMessage" style="width:1100px; margin-left:50px;color:white">
                                ...
                                <div class="basic-form">
                                    <form method="POST" onsubmit="return validateForm()">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="name" id="name" class="form-control" placeholder="Enter role Name" style="height: 50px;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description" id="description" class="form-control" placeholder="Enter Role Description" style="height: 100px;"></textarea>
                                                <div id="descriptionError" class="error"></div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                <button type="submit" name="add_role" class="btn btn" style=" background-color:#001F3F;">
                                                    Submit</button>
